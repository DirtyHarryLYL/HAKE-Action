...
COMMON_FLAGS += -I/opt/protobuf-3.2/include -DCAFFE_VERSION=$(DYNAMIC_VERSION_MAJOR).$(DYNAMIC_VERSION_MINOR).$(DYNAMIC_VERSION_REVISION)
...
LIBRARIES += glog gflags protobuf boost_system boost_filesystem m hdf5_hl hdf5 opencv_imgcodecs opencv_core opencv_highgui opencv_imgproc opencv_videoio
